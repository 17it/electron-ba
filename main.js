...
let tray
function initTray() {
    // const icon = nativeImage.createFromPath('/Users/tony/Documents/playground/electron-ba/public/404.png')
    // const icon = nativeImage.createFromPath(path.join(__dirname, 'public/404.png'))
